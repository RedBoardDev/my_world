...
void inits_obj(spritesheet_t *spritesheet, beginning_t *begin)
{
    ...
    set_sprite("ressources/img/hauteur.png", &spritesheet[S_HAUTEUR], begin, (init_sprite_t){{1400, (HEIGHT / 4) * 2.3}, {0.2, 0.2}, {0, 0, 2000, 541}});
    set_sprite("ressources/img/largeur.png", &spritesheet[S_LARGEUR], begin, (init_sprite_t){{1400, (HEIGHT / 4) * 1.7}, {0.2, 0.2}, {0, 0, 2000, 541}});
