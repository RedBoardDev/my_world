...
{
    world->begin.guiworld.toggle_move = (world->begin.guiworld.toggle_move) ? false : true;
...
{
    world->begin.guiworld.painter = (world->begin.guiworld.painter) ? false : true;
    world->maps.painter = (world->maps.painter) ? false : true;
}

void button_rotate_360(world_t *world)
{
    world->begin.guiworld.rotate_360 = (world->begin.guiworld.rotate_360) ? false : true;
}
